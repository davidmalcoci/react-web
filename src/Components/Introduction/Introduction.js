            ...
            <div className="container">
                <div className="row fill-viewport align-items-center">
                    <div className="col-sm-12 col-md-6">
                        ...
                        <p className="text-white-60">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Vestibulum in rutrum eros, in consequat nulla. Donec ac porttitor tortor.</p>
